    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundColor: WorkFlowStatusColor[keyType].bgColor,
            borderColor: selected ? '#fff' : WorkFlowStatusColor[keyType].bgColor,
            color: WorkFlowStatusColor[keyType].color,
          }}
        >
          {name}
        </div>
